...
The *microRTPS* bridge exchanges messages between PX4 and RTPS applications, seamlessly converting between the [uORB](../middleware/uorb.md) and RTPS/DDS messages used by each system.
...
:::note
[Fast RTPS 1.8.2 and FastRTPSGen 2.0.0 or later must be installed](../dev_setup/fast-rtps-installation.md) in order to generate the required code!
:::
